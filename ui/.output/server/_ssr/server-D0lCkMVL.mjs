...
import { m as require_jsx_runtime } from "../_libs/@material-tailwind/react+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DG4cG6qq.mjs");
