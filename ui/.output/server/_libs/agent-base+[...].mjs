...
var require_supports_color = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = (function() {
		...
		if (hasFlag("no-color") || hasFlag("no-colors") || hasFlag("color=false")) return false;
		if (hasFlag("color") || hasFlag("colors") || hasFlag("color=true") || hasFlag("color=always")) return true;
